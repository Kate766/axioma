...
var HeaderComponent = _vue2.default.component('header-component', {
    template: '#header',
    components: {},
    delimiters: ['[[', ']]'],
    computed: {
    ...
    mounted: function mounted() {
        ...
        // window.addEventListener('scroll', this.tinifyHeader)
...
var AboutRootComponent = _vue2.default.component('about-root-component', {
    template: '#about',
    components: { Tabs: _Tabs2.default },
    delimiters: ['[[', ']]'],
    computed: {
        title: function title() {
            // return this.$refs.tab._data.activeTabHash.split('#')[1]
        }
    },
    data: function data() {
        return {
...
exports.default = AboutRootComponent;
...
var _veeValidate = __webpack_require__(54);

var _veeValidate2 = _interopRequireDefault(_veeValidate);

var _vMask = __webpack_require__(53);
...
var ContactRootComponent = _vue2.default.component('contact-root-component', {
    template: '#contact-root-component',
    delimiters: ['[[', ']]'],
    data: function data() {
        return {
            name: '',
    ...
    methods: {
        createMap: function createMap() {
            ...
            function init() {
                myMap = new ymaps.Map("map1", {
                    center: [51.1247855, 71.4890027],
                    zoom: 16
                });

                myPlacemark = new ymaps.Placemark([51.1247855, 71.4890027], {});

                myMap.geoObjects.add(myPlacemark);
            }
        },
        makePostReady: function makePostReady(object) {
        ...
        validateBeforeSubmit: function validateBeforeSubmit(e) {
            ...
            if (!this.errors.any()) {
                ...
                _axios2.default.post('./../../send-email.php', this.makePostReady(obj), {
...
exports.default = ContactRootComponent;
...
var _galleryDataComponent = __webpack_require__(48);

var _galleryDataComponent2 = _interopRequireDefault(_galleryDataComponent);

var _galleryVideoComponent = __webpack_require__(50);

var _galleryVideoComponent2 = _interopRequireDefault(_galleryVideoComponent);

var _galleryItem = __webpack_require__(49);

var _galleryItem2 = _interopRequireDefault(_galleryItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var GalleryRootComponent = _vue2.default.component('gallery-root-component', {
    template: '#gallery',
    components: { GalleryDataComponent: _galleryDataComponent2.default, GalleryVideoComponent: _galleryVideoComponent2.default, GalleryItem: _galleryItem2.default },
    delimiters: ['[[', ']]'],
    computed: {
        title: function title() {
            // return this.$refs.tab._data.activeTabHash.split('#')[1]
...
exports.default = GalleryRootComponent;
...
var IndexComponent = _vue2.default.component('IndexComponent', {
    template: '#index',
    components: {},
    delimiters: ['[[', ']]'],
    data: function data() {
    ...
    computed: {},
    methods: {
        scale: function scale(slide) {
            (0, _jquery2.default)('.swiper-slide').find('.swiper-slide__part--left').stop(true).animate({ 'opacity': 0, 'scale': 0.8, 'left': '30%' }, 1000, function () {
                // $(this).css({ 'display': 'none' });

            });
        },
        horiz_page_animate: function horiz_page_animate(t) {

            (0, _jquery2.default)('.mask').html('<img class="page_change_line horiz n1 events-none" src="./static/img/big_red.png" /><img class="page_change_line horiz n2 events-none" src="./static/img/small_red.png" /><img class="page_change_line horiz n3 events-none" src="./static/img/big_white.png" /><img class="page_change_line horiz n4 events-none" src="./static/img/small_white.png" />').find('.page_change_line.n1').css({ 'left': '100%', 'translate3d': 0, 'position': 'absolute', 'z-index': 1, 'height': '100%' }).animate({ 'left': '-69%' }, t, function () {
                (0, _jquery2.default)(this).remove();
            }).end().find('.page_change_line.n2').css({ 'left': '-50%', 'translate3d': 0, 'position': 'absolute', 'z-index': 1, 'height': '100%' }).animate({ 'left': '100%' }, t, function () {
                (0, _jquery2.default)(this).remove();
            }).end().find('.page_change_line.n3').css({ 'left': '-46%', 'translate3d': 0, 'position': 'absolute', 'z-index': 1, 'height': '100%' }).delay(0.2 * t).animate({ 'left': '100%' }, 0.8 * t, function () {
                (0, _jquery2.default)(this).remove();
            }).end().find('.page_change_line.n4').css({ 'left': '100%', 'translate3d': 0, 'position': 'absolute', 'z-index': 1, 'height': '100%' }).delay(0.2 * t).animate({ 'left': '-40%' }, 0.8 * t, function () {
                (0, _jquery2.default)(this).remove();
            });
        }
    },
    mounted: function mounted() {
        var horiz_page_animate = this.horiz_page_animate;
        ...
        var mySwiper = new _swiper2.default('.swiper-container', {
            ...
            onSlideChangeStart: function onSlideChangeStart(swiper) {
                if (window.innerWidth > 1200) {
                    scale();
                    horiz_page_animate(2500);
                }
            },
            onSlideChangeEnd: function onSlideChangeEnd() {
                if (window.innerWidth > 1200) {
                    (0, _jquery2.default)('.swiper-slide-active').find('.swiper-slide__part--left').stop(true).css({ 'left': '0%', 'opacity': 0, 'scale': 0.9 }).animate({ 'opacity': 1, 'scale': 1 }, 800);
                }
            }
        });
    }
...
_vue2.default.use(_vuex2.default); // import "babel-polyfill"

var eventbus = new _vue2.default();

new _vue2.default({
    el: '#app',
    components: { HeaderComponent: _header2.default, FooterComponent: _footer2.default, IndexComponent: _Index2.default, AboutRootComponent: _About2.default, GalleryRootComponent: _gallery2.default, ContactRootComponent: _contact2.default },
    computed: {},
    data: function data() {
        return {
            loading: true
    ...
    mounted: function mounted() {
        ...
        _eventbus.EventBus.$on('disableScroll', function () {
            _this.$refs.body.parentNode.classList.add('is-passive');
        });
        _eventbus.EventBus.$on('close', function () {

            _this.$refs.body.parentNode.classList.remove('is-passive');
        });
        this.loading = !this.loading;
        this.$refs.body.parentNode.classList.remove('is-disabled');
...
var CustomSwiper = _vue2.default.component('about-slide-component', {
    ...
    methods: {
        isVisible: function isVisible() {
            return this.ref = this.$refs.slider.children.length;
        },
        createSwiper: function createSwiper() {
            var mySwiper = new _swiper2.default('.horizontal-swiper', {
                direction: 'horizontal',
                loop: false,
                // autoHeight: true,
                // observer: true,
...
var _Slide = __webpack_require__(46);

var _Slide2 = _interopRequireDefault(_Slide);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TabsComponent = _vue2.default.component('tabs-component', {
    template: '#tabs',
    components: { CustomSwiper: _Slide2.default },
    computed: {},
    data: function data() {
        return {};
    },
    ...
    methods: {
        emitEvent: function emitEvent(e) {
            if (e.target.classList.contains('swiper-pagination-bullet')) {
                var breadcrumb = e.target.innerHTML;
                this.$emit('sendBreadcrumb', breadcrumb);
            }
        },
        createMap: function createMap() {
            ymaps.ready(init);
            ...
            function init1() {
                ...
                myPlacemark1 = new ymaps.Placemark([51.1247855, 71.4890027], {});
            ...
            function init2() {
                ...
                myPlacemark2 = new ymaps.Placemark([51.1247855, 71.4890027], {});
    ...
    mounted: function mounted() {
        this.createMap();
        var bullets = ['описание', 'инфраструктура', 'расположение', 'архитектура', 'генеральный план', 'партнеры'];
        var mySwiper = new _swiper2.default('.about-swiper-container', {
            ...
            paginationBulletRender: function paginationBulletRender(swiper, index, className) {
                return '<span class="' + className + ' about-swiper-pagination__bullet">' + bullets[index] + '</span>';
            }
        });
    }
});
...
var _vueSlick = __webpack_require__(55);
...
var GallerySlidesComponent = _vue2.default.component('gallery-slides-component', {
    template: '#gallery-slides-component',
    delimiters: ['[[', ']]'],
    ...
    updated: function updated() {
        (0, _jquery2.default)('.gallery-swiper').append((0, _jquery2.default)('.icon-gallery--left'), (0, _jquery2.default)('.icon-gallery--right'), (0, _jquery2.default)('.overlay__close'));
        // $('.slick-prev').replaceWith(this.$refs.prev)
        // $('.slick-next').replaceWith(this.$refs.next)
        ...
        //     initialSlide: 1,
        //     onlyExternal: false,
        //     prevButton: '.icon-gallery--left',
        //     nextButton: '.icon-gallery--right',
        //     preloadImges: true,
        //     updateOnImagesReady: true,
        //     breakpoints: {
        //         1280: {
...
exports.default = GallerySlidesComponent;
...
var GalleryItem = _vue2.default.component('gallery-item', _defineProperty({
    ...
    methods: {
        triggerShow: function triggerShow() {
            ...
            _eventbus.EventBus.$emit('disableScroll');
        }
    }
}, 'mounted', function mounted() {}));
...
var GalleryVideoComponent = _vue2.default.component('gallery-video-component', {
    template: '#gallery-video-component',
    delimiters: ['[[', ']]'],
    data: function data() {
        return {
            isHidden: true
...
exports.default = GalleryVideoComponent;
...
Component.options.__file = "D:\\projects\\apps\\axe\\node_modules\\vue-slick\\slickCarousel.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b1a10f78", Component.options)
  } else {
    hotAPI.reload("data-v-b1a10f78", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b1a10f78", module.exports)
  }
}
